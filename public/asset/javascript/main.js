...
; (function ($) {
    ...
    var retinaLogos = function () {
        ...
        if (retina) {
            $('#a2').attr({ src: 'https://res.cloudinary.com/dyv0lsr1o/image/upload/v1744172285/logo2_zrohpe.png', width: '190', height: '42' });
            $('#a3').attr({ src: 'https://res.cloudinary.com/dyv0lsr1o/image/upload/v1744172285/logo2_zrohpe.png', width: '124', height: '42' });
            $('#a1').attr({ src: 'https://res.cloudinary.com/dyv0lsr1o/image/upload/v1744172285/logo2_zrohpe.png', width: '125', height: '43' });
